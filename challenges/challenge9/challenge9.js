...
Suppose we get data from a web service about a certain gameelow) (b. In this challenge we're gonna work with the datao . Shere are your tasks:

1. Create one player array for each team (variables 'players1' and 'players2')

2. The first player in any player array is the goalkeeper and the others are field players. Forn Bayer Munich (team 1) create one variable ('gk') with the goalkeeper's name, and one array( 'fieldPlayers') with all the remaining 10 field players
...
*Lewandowski' and 'Kimmich'. Then, call the function again with players from game.scorerd
...
// Goal1:lewakoni------->(its just a hint)

for (const [i, player] of game.scored.entries()) {
  // here the i gets the value of index no and the players gets the value of value in the array which are extracted from entries(both index no. and values)
...
/// for the solution best solution by sir in lect 26 chapter 8
